package dev.drrockymc.shulkerdupecz.commands;

import dev.drrockymc.shulkerdupecz.util.ChatUtil;
...
public class CommandBase implements CommandExecutor {
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (args.length == 1)
                switch (args[0]) {
                    case "info":
                        ...
                        break;
                    case "help":
                        player.sendMessage(ChatUtil.color("&8-----&eShulker&d&lDupe&8作者:&b2B2TDrRockyMC&f, &8原作者:&bjiyun233"));
            ...
            if (args.length < 1) {
                player.sendMessage(ChatUtil.color("&8-----&eShulker&d&lDupe&8作者:&9&b 2B2TDrRockyMC&f, &8原作者: &9&bjiyun233"));
                player.sendMessage(ChatUtil.color("&a/sd info &6                      查看您的复制数量!"));
                player.sendMessage(ChatUtil.color("&a/sd info <ID>&6                  查看他人复制数量!"));
                player.sendMessage(ChatUtil.color("&a/sd dupe on &6                       开启dupe喵~"));
                player.sendMessage(ChatUtil.color("&a/sd dupe off &6                      禁用dupe喵~"));
